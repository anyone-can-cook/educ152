...
- OLS Prediction Line (with estimates)   
   - $\hat{Y_i} =$  `r format(round(summary(mbdamod1)$coefficients[1,1], digits =2),big.mark = ',')` + `r round(summary(mbdamod1)$coefficients[2,1], digits =2)` $\times X_i$
...
- Interpretation of $\hat{\beta_1}=$ `r round(summary(mbdamod1)$coefficients[2,1], digits =2)`
  - barely passable interpretation: "a one-unit increase in $X$ is associated with a `r round(summary(mbdamod1)$coefficients[2,1], digits =2)` unit increase in $Y$"
  - better interpretation: "a one-dollar increase in annual cost of attendance is associated with a `r round(summary(mbdamod1)$coefficients[2,1], digits =2)` dollar increase in institution-level student earnings"
...
- Therefore, a one-unit change in $X$ is associated with a $\hat{\beta_1}$ change in $Y$ no matter the starting value of $X$, for example:
  - going from $X=20,000$ to $X=20,001$ is associated with a $\hat{\beta_1}=$ `r round(summary(mbdamod1)$coefficients[2,1], digits =2)` increase in $Y$
  - going from $X=40,000$ to $X=40,001$ is associated with a $\hat{\beta_1}=$ `r round(summary(mbdamod1)$coefficients[2,1], digits =2)` increase in $Y$
...
- Example:
  - $\Delta X = 5,000$: a $5,000$ dollar increase in annual cost of attendance is associated with a $\hat{\beta_1}*\Delta X=$ `r round(summary(mbdamod1)$coefficients[2,1]*5000, digits =2)` increase in predicted institution-level student earinings
  - $\Delta X = -200$: a $200$ dollar decrease in annual cost of attendance is associated with a $\hat{\beta_1}*\Delta X=$ `r round(summary(mbdamod1)$coefficients[2,1]*-200, digits =2)` decrease in predicted institution-level student earinings
