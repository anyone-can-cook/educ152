...
- Here, $\beta_0$, is the average value of of the variable institution-level student debt at a university where cost of attendance equals $0 (X=0)
...
- $u_i$ as the residual
  - Population regression line represents the predicted value of Y (institution-level student debt) for each value of X (cost of attendance)
...
### Estimation in R using `lm()` [KEEP?]

Let's write run our first regression and write out our models!

<br>
  
RQ: What is the effect of cost of attendance on institution-level student debt? 
