...
df_generated_pop %>% plot_distribution('norm_dist')

# Randomly generated data: left-skewed
df_generated_pop %>% plot_distribution('lskew_dist')

# Randomly generated data: right-skewed
df_generated_pop %>% plot_distribution('rskew_dist')

# IPEDS data: tuitfee_grad_res
df_ipeds_pop %>% plot_distribution('tuitfee_grad_res')
```
...
```{r}
# IPEDS data: tuitfee_grad_res by control
df_ipeds_pop %>% plot_distribution('tuitfee_grad_res', 'control')

# IPEDS data: tuitfee_grad_res by control, shade histogram
df_ipeds_pop %>% plot_distribution('tuitfee_grad_res', 'control', show_group_hist = T)

# IPEDS data: tuitfee_grad_res by control, custom order
df_ipeds_pop %>% plot_distribution('tuitfee_grad_res', 'control', group_cat = c(2, 1))

# IPEDS data: tuitfee_grad_res by control, custom categories
df_ipeds_pop %>% plot_distribution('tuitfee_grad_res', 'control', group_cat = c(2, 3))
```
...
# Randomly generated data: standard normal
df_generated_sample %>% plot_distribution('stdnorm_dist')

# Randomly generated data: normal
df_generated_sample %>% plot_distribution('norm_dist')

# Randomly generated data: left-skewed
df_generated_sample %>% plot_distribution('lskew_dist')

# Randomly generated data: right-skewed
df_generated_sample %>% plot_distribution('rskew_dist')
...
```{r}
# Randomly generated data: standard normal
df_generated_pop %>% plot_distribution('stdnorm_dist', sampling_dist = T)

# Randomly generated data: normal
df_generated_pop %>% plot_distribution('norm_dist', sampling_dist = T)

# Randomly generated data: left-skewed
df_generated_pop %>% plot_distribution('lskew_dist', sampling_dist = T)

# Randomly generated data: right-skewed
df_generated_pop %>% plot_distribution('rskew_dist', sampling_dist = T)

# IPEDS data: tuitfee_grad_res
df_ipeds_pop %>% plot_distribution('tuitfee_grad_res', sampling_dist = T)
```
...
df_ipeds_pop %>% plot_distribution('tuitfee_grad_res', 'control', sampling_dist = T)

# IPEDS data: tuitfee_grad_res by control (control=2 minus control=1)
df_ipeds_pop %>% plot_distribution('tuitfee_grad_res', 'control', group_cat = c(2, 1), sampling_dist = T)
```
...
df_ipeds_sample %>% plot_t_distribution('coa_grad_res', mu = 29000)
...
df_ipeds_sample %>% plot_t_distribution('coa_grad_res', mu = 32000)
...
df_ipeds_sample %>% plot_t_distribution('coa_grad_res', mu = 33000, alternative = 'less')
...
df_ipeds_sample %>% plot_t_distribution('coa_grad_res', mu = 31000, alternative = 'greater')
```
...
# Verdict: Fail to reject H0
t.test(formula = tuitfee_grad_res ~ control, mu = 0,
       data = df_ipeds_sample, subset = unclass(control) %in% c(1, 2))
# t-statistics line is off the grid
df_ipeds_sample %>% plot_t_distribution('tuitfee_grad_res', 'control', group_cat = c(1, 2))
```
...
# Example including hypothesis testing - need to specify stacked = T
