...
- __Interpretation of $\hat{\beta_1}$__
  - General: being in the "non-reference group" as opposed to the "reference group" is, on average, associated with  a $100*\hat{\beta_1}$ percentage point change in the probability of Y=1
