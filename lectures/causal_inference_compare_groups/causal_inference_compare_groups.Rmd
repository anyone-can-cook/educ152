...
# PLOT SAMPLING DISTRIBUTION OF TWO POPULATIONS     
    ...
    plot_distribution(data_df = df_ipeds_pop, data_var = 'tuitfee_grad_res', group_var = 'control', group_cat = c(2, 1), sampling_dist = T, pop_labels = c('Public', 'Private'))
...
**Hypothesis about nonresident grad tuition+fees at private vs. public universities**

*note*: for private universities, nonresident price is the same as resident price

null hypothesis ($H_0$)

- $H_0: \mu_{Y_{{priv}}} = \mu_{Y_{{pub}}}$
- (in words): $H_0:$ the population mean price of nonresident tuition+fees at private universities, $\mu_{Y_{{priv}}}$, is the same as population mean price of nonresident tuition+fees at public universities ($\mu_{Y_{{pub}}}$)

Two-sided alternative hypothesis ($H_a$)

- $H_0: \mu_{Y_{{priv}}} \ne \mu_{Y_{{pub}}}$
- (in words): $H_0:$ the population mean price of nonresident tuition+fees at private universities, $\mu_{Y_{{priv}}}$, is not equal to the population mean price of nonresident tuition+fees at public universities ($\mu_{Y_{{pub}}}$)
