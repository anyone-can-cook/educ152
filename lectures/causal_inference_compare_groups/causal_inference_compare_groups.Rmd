...
**Example research questions we will use to explain causal inference concepts**
...
What is the effect of having a "small" class size ($T_i=1$) vs. "large" class size ($T_i=0$) on achievement test score ($Y$) for elementary school students?
