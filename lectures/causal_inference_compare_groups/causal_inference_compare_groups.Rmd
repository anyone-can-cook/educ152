...
*note*: for private universities, resident price is the same as resident price
...
Usually we cannot create the true sampling distribution because we do not have data on the entire population. So we test hypotheses about equality of two groups by creating the sampling distribution of the difference between sample means, ($\bar{Y}_{group1} - \bar{Y}_{group1}$) under the assumption that $H_0$ is true
